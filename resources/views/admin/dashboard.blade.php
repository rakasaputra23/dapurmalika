            ...
            <tbody>
                ...
                <tr class="text-center border-b">
                    ...
                    <td class="px-4 py-2 flex justify-center gap-2">
                        <button onclick="showEdit({{ $menu }})" class="bg-yellow-500 text-white px-2 py-1 rounded hover:bg-yellow-400">Edit</button>
...
<script>
    function showEdit(menu) {
        ...
        document.getElementById('editForm').action = `/admin/dashboard/update/${menu.id}`;
    }
